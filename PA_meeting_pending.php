<!--
    Modified By Akila on 4 April2007 For BU Head as Reviewing Manager Change
-->
...
$res_func=pg_query($db_conn,"SELECT func_name,emp_master FROM func_master WHERE emp_master.emp_code=$ecode AND emp_master.func=func_master.func_id");
...
for($i=0;$i<$proj_rows;$i++)
 {
  ...
  <td colspan=\"4\">$proj_a</td>
  
  </tr>
  
   <tr>
       <td colspan=\"2\">Task Assigned in Project</td><td colspan=\"4\">$task_a</td>
	</tr>
    <tr>
      <td>Sl No</td>
...
<tr bgcolor='#E5E7E9'><td colspan =2><b>Job Performance</b></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr>
      <td>Factor(1)</td>
      <td>Weight<br>(2)</td>
